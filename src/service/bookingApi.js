...
export const getOnewayList = (departure, arrive, startDate) => async(dispatch) => {
    const url = 'http://13.125.244.223:9000/booking/availability';
...
export const getUserInfo = () => async(dispatch) => {
    ...
    const url = 'http://13.125.244.223:9000/booking/user';
    const data = { 'id': id };
...
export const getSeats = (fnum) => async(dispatch) => {
    const url = 'http://13.125.244.223:9000/booking/seats';
